...
<div class="container menu-resevaciones p-t-70">
	<div class="row">
		<div class="col-12 col-md-2 col-xl-2 col-lg-2 text-center m-t-20"><a class="active" href="<?= base_URL('/reservacion/').$Idioma?>">1.-<?=($Idioma==='es')?'Fecha de estadía':'Stay Date'?></a></div>
